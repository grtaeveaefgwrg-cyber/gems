  ...
  return (
    <div className="relative my-6">
      ...
      <input
        ...
        className="w-full bg-slate-800/80 ring-1 ring-slate-700 rounded-full py-3 pl-12 pr-4 text-white placeholder-slate-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-colors"
      />
    </div>
  );
};
